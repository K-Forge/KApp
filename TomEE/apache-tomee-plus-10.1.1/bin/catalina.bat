...
rem Configure module start-up parameters - ensure to keep it in line with service.bat
...
:doVersion
%_EXECJAVA% %JAVA_OPTS% -classpath "%CATALINA_HOME%\lib\catalina.jar;%CATALINA_HOME%\lib\openejb-core-10.1.1.jar" org.apache.catalina.util.ServerInfo
goto end
