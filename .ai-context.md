...
**K-APP** es una plataforma universitaria para la Fundación Universitaria Konrad Lorenz, desarrollada por el club K-Forge. Arquitectura de microservicios con Spring Boot.
